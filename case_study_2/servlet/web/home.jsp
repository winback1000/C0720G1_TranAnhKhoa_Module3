...
<div id="window-header" class="container-fluid">
    <a href="home.html"><img src="logo.png" width="100px" height="120px"></a>
    <div id="users">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="#">Other Convenience</a>
                    </div>
                </li>
                <li class="nav-item active">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <a href="/home?action=employee"><img class="d-block w-100" src="pics/employee.jpg" alt="First slide"></a>
            ...
            <div class="carousel-item">
                <a href="/home?action=villa"><img class="d-block w-100" src="pics/villa.jpg" alt="Second slide"></a>
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <a href="/home?action=customer"><img class="d-block w-100" src="pics/customer2.jpg" alt="Third slide"></a>
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <a href="/home?action=house"><img class="d-block w-100" src="pics/house.jpg" alt="Third slide"></a>
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <a href="/home?action=room"><img class="d-block w-100" src="pics/room.jpg" alt="Third slide"></a>
                <div class="carousel-caption d-none d-md-block">
